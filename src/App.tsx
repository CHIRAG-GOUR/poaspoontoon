...
function App() {
  return (
    <BrowserRouter>
      <div className="w-full min-h-screen relative bg-green-50/50">
        ...
        <div className="relative z-10 w-full pt-10">
          <Routes>
            ...
            <Route path="/chapter-2.1" element={<ChapterFour />} />
            <Route path="/chapter-2.2" element={<ChapterFive />} />
            <Route path="/chapter-2.3" element={<ChapterSix />} />
            <Route path="/chapter-2.4" element={<ChapterSeven />} />
          </Routes>
        </div>
